...
def get_config() -> config_dict.ConfigDict:
    ...
    config.training_shards = 160
    config.validation_shards = 6
    ...
    config.record_shuffle_buffer = 1000000   # Record-level shuffle buffer size (training)
    config.batch_shuffle_buffer = 50       # Batch-level shuffle buffer size

    config.classes = -1
    config.max_length = 128
    config.tokenizer = "data/sentencepiece_tokenizer_safe_bpe_4000.model"
